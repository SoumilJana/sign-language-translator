...
while True:
            ...
            if hold_start_time is None:
                ...
                if stable_letter.lower() == "space":
                    if last_added != " " or (current_time - last_added_time) > cooldown:
                        ...
                        if words:
                            # correct the last word before space
                            last_word = words[-1]
                            corrected_word = autocorrect_text(last_word)
                        ...
                        print("⬜ Space added (previous word corrected)")
    ...
    if key in [ord('q'), 27]:  # Quit
        ...
        if sentence.strip():
            ...
            # Step 1: autocorrect
            final_text = autocorrect_text(final_text)
